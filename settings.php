...
<body class="bg-theme bg-<?php echo $_SESSION['background']; ?>">
	...
	<div class="wrapper">
		...
		<div id="stepdiv1" class="totallyHide section-authentication-signin d-flex align-items-center justify-content-center my-5 my-lg-0">
						...
						<div class="card-body onboarding-card mt-2 d-flex justify-content-center">
									...
									<div class="scrollable-div">
										<div class="col-12 mb-2">
											...
											<div class="col-12 mb-2">
												...
												<input type="text" class="form-control border-white mb-2" id="inputFirstName" name="inputFirstName" placeholder="First name" value=<?php echo $splitName[0]; ?>>
												<input type="text" class="form-control border-white mb-2" id="inputLastName" name="inputLastName" placeholder="Last name" value=<?php echo $splitName[1]; ?>>
											</div>
											<div class="col-12 mb-2">
												<span class="mb-2 text-white">Upload a picture of yourself (jpg or png under 8MB)</span>
												<div class="col-12">
											...
											<div class="col-12 mb-2">
												...
												<input type="email" readonly class="form-control border-white mb-2" id="inputEmail" name="inputEmail" placeholder="name@email.com" value=<?php echo $_SESSION["emailaddress"]; ?>>
											</div>

											<div class="col-12 mb-2">
												<span class="mb-2 text-white">Backup Email </span>
												<input type="email" class="form-control border-white mb-2" id="inputBackupEmail" name="inputBackupEmail" placeholder="name@email.com">
											</div>

											<div class="col-12">
												<label for="inputChoosePassword" class="form-label text-white">Current Password<sup>*</sup></label>
												<div class="input-group" id="show_hide_password">
													<input type="password" class="form-control border-end-0 border-white" id="inputChoosePassword" name="inputChoosePassword" placeholder="Enter Password"> <a href="javascript:;" class="input-group-text bg-transparent border-white"><i class='bx bx-hide'></i></a>
												</div>

												<label for="inputNewPassword" class="form-label text-white mt-2">New Password<sup>*</sup></label>
												<div class="input-group" id="show_hide_password">
													<input type="password" class="form-control border-end-0 border-white" id="inputNewPassword" name="inputNewPassword" placeholder="Enter New Password"> <a href="javascript:;" class="input-group-text bg-transparent border-white"><i class='bx bx-hide'></i></a>
												</div>
											</div>
										</div>
							...
							<div class="d-flex justify-content-center settings-btn">
								<div class="d-flex justify-content-start col-6">
									<button type="button" onclick="back(1);" class="btn btn-transpaernt text-white btn-next">Cancel</button>
								</div>

								<div class="d-flex justify-content-end  col-5">
									<button type="submit" class="btn btn-white btn-next" tag="userSettings">Save Changes</button>
								</div>
							</div>
		...
		<div id="stepdiv2" class="totallyHide section-authentication-signin d-flex align-items-center justify-content-center my-5 my-lg-0">
			<div class="container settings-container-form">
				<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
					<div class="card mb-0 cardClear">
						<div class="card-body onboarding-card mt-2 d-flex justify-content-center">
										...
										<div class="col-12 mb-2">
											<div class="prof">
												<div class=" mb-2 account-profile-header">
													...
													<p class="main-label">Manage the profile information for the subject of this account.</p>
												</div>
												<div class="account-profile-content">
													<div class="col-12 mb-2">
														<span class="mb-2 text-white">Name <sup>*</sup></span>
														<input type="text" class="form-control border-white mb-2" id="inputFirstName_acc" name="inputFirstName_acc" placeholder="First name" required>
														<input type="text" class="form-control border-white mb-2" id="inputMiddletName_acc" name="inputMiddletName_acc" placeholder="Middle name">
														<input type="text" class="form-control border-white mb-2" id="inputLastName_acc" name="inputLastName_acc" placeholder="Last name" required>
														<div class="text-end">
															<span id="invite" style="cursor:pointer;" class="text-white"><u>Invite</u></span>
														</div>
													</div>
													<div class="col-12 mb-3">
														<span class="mb-2 text-white" id="birth-label">Date of Birth <sup>*</sup></span>
														<input type="date" class="form-control border-white mb-2" id="inputDOB" name="inputDOB" placeholder="Select a date" required>
													</div>
													<div class="col-12 mb-3">
														<span class="mb-2 text-white">Place of birth <sup>*</sup></span>
														<input type="text" class="form-control border-white mb-2" id="inputCity" name="inputCity" placeholder="City" required>
														<input type="text" class="form-control border-white mb-2" id="inputState" name="inputState" placeholder="State/Province/Territory">
														<input type="text" class="form-control border-white mb-2" id="inputCountry" name="inputCountry" placeholder="Country" required>
													</div>
													<div class="col-12 mb-3">
														<span class="mb-2 text-white" id="birth-label">Date of passing </span>
														<input type="date" class="form-control border-white mb-2" id="inputDateofPassing" name="inputDateofPassing" placeholder="Select a date">
													</div>
													<div class="col-12 mb-3">
														<span class="mb-2 text-white">Place of passing</span>
														<input type="text" class="form-control border-white mb-2" id="inputPassingPlace" name="inputPassingPlace" placeholder="City">
													</div>
												</div>
											</div>
										</div>
							...
							<div class="d-flex justify-content-center settings-btn">
								...
								<div class="d-flex justify-content-end  col-5">
									<button type="button" tag="accountProfile" class="btn btn-white btn-next">Save Changes</button>
								</div>
							</div>
						</div>
					</div>
		...
		<div id="stepdiv3" class="totallyHide section-authentication-signin d-flex align-items-center justify-content-center my-5 my-lg-0">
			<div class="container settings-container-form">
				<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
					...
					<div class="card mb-0 cardClear">
						<div class="card-body onboarding-card mt-2 d-flex justify-content-center">
								...
								<form class="row g-3" method="POST" action="settings.php" enctype="multipart/form-data">
									...
									<div class="scrollable-div">
										<div class="col-12 mb-2">
											...
											<div class="col-12">
												<label for="inputCollection" class="form-label text-white">Who can view your timeline?</label>
												<select class="form-select border-white" id="VIEW_RIGHT" name="VIEW_RIGHT_timeline">
													<option>Select Option </option>
													<option value="1098" <?php if ($_SESSION["profileviewability"] == "1098"): ?> selected <?php endif ?>>All Connections</option>
													<option value="1099" <?php if ($_SESSION["profileviewability"] == "1099"): ?> selected <?php endif ?>>Anyone (Public)</option>
													<option value="1101" <?php if ($_SESSION["profileviewability"] == "1101"): ?> selected <?php endif ?>>Only Family (Default)</option>
													<option value="1140" <?php if ($_SESSION["profileviewability"] == "1140"): ?> selected <?php endif ?>>Only me</option>
												</select>
											</div>
											<br>
											<div class="col-12">
												<label for="inputCollection" class="form-label text-white">Who can view your family tree?</label>
											...
											<p class="mt-4 text-white">You may also set permissions on individual memories on your timeline.</p>
										</div>
							...
							<div class="d-flex justify-content-center settings-btn">
								...
								<div class="d-flex justify-content-end  col-5">
									<button type="button" class="btn btn-white btn-next" tag="accountPrivacy">Save Changes</button>
								</div>
							</div>
		...
		<div id="stepdiv4" class="totallyHide section-authentication-signin d-flex align-items-center justify-content-center my-5 my-lg-0">
			<div class="container settings-container-form">
				<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
					...
					<div class="card mb-0 cardClear">
						<div class="card-body onboarding-card mt-2 d-flex justify-content-center">
										...
										<div class="col-12 mb-2">
											...
											<div class="col-12 mb-3">
												...
												<div class="col-12 mt-3">
													<p class="text-white ">Choose a background for your app from the options below.</p>
												...
												<div class="col-12 mt-3">
													<p class="text-white">Choose an accent color for your app from the options below.</p>
													...
													<div class="row toggle-switch-container">
														<div class="col-2 accent">
															...
															<div class="letter-square text-white accent selected" mode="light" tag="rgba(0,0,0,0.6)" style="background-color:rgba(0, 0, 0, 0.6);">A</div>
														</div>
														<div class="col-2 accent">
							...
							<div class="d-flex justify-content-center settings-btn">
								...
								<div class="d-flex justify-content-end  col-5">
									<button type="submit" class="btn btn-white btn-next" tag="accountCustom">Save Changes</button>
								</div>
							</div>
		...
		<div id="stepdiv5" class="totallyHide section-authentication-signin d-flex align-items-center justify-content-center my-5 my-lg-0">
			<div class="container settings-container-form">
				<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
								...
								<form class="row g-3">
									<div class="scrollable-div">
										<div class="col-12 mb-2">
											...
											<div class="col-12">
												<label for="inputCollection" class="form-label text-white">You have made the following connection a guest administrator for this account:</label>
											...
											<hr>
											<div class="col-12">
												<label for="inputCollection" class="form-label text-white">You are a guest administrator for the following accounts:</label>
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <button class="text-center btn btn-white"> Switch to this account</button>
							...
							<div class="d-flex justify-content-center settings-btn">
								...
								<div class="d-flex justify-content-end  col-5">
									<button type="button" tag="accountGuest" class="btn btn-white btn-next">Save Changes</button>
								</div>
							</div>
		...
		<div id="stepdiv6" class="totallyHide section-authentication-signin d-flex align-items-center justify-content-center my-5 my-lg-0">
			<div class="container settings-container-form">
				<div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
										...
										<div class="col-12 mb-2">
											...
											<div class="col-12 mb-2 row">
												<div class="col-12 mb-2 d-flex align-items-center">
													<input type="text" class="form-control border-white me-2" id="inputFirstName_acc" name="inputFirstName_acc" placeholder="Tag" required>
												...
												<div class="col-12 mb-2 d-flex align-items-center">
													<input type="text" class="form-control border-white me-2" id="inputMiddletName_acc" name="inputMiddletName_acc" placeholder="Tag Sample">
													<button type="button" class="btn btn-transparent btn-sm">
														<i class="bi bi-trash text-white"></i>
													</button>
												</div>
												...
												<div class="col-12 mb-2 d-flex align-items-center">
													<input type="text" class="form-control border-white me-2" id="inputLastName_acc" name="inputLastName_acc" placeholder="Tag Sample" required>
													<button type="button" class="btn btn-transparent btn-sm">
														<i class="bi bi-trash text-white"></i>
													</button>
												</div>
					...
					<div class="settings-options" id="settings-options">
						<div class="setings-container mb-2">
							<div class="headingTabTitle">
								<img id="stept1-trigger" src="assets/images/icons/settings.svg" alt="Open Setting" class="img-fluid open-settings">
						...
						<div class="setings-container mb-2">
							<div class="d-flex justify-content-between align-items-center">
								...
								<img id="stept1-trigger" src="assets/images/icons/open.svg" alt="Open Setting" class="img-fluid open-settings">
							</div>
						...
						<div class="setings-container mb-2">
							<div class="d-flex justify-content-between align-items-center">
								...
								<img id="stept2-trigger" src="assets/images/icons/open.svg" alt="Open Setting" class="img-fluid open-settings">
							</div>
							<p class="mt-2 main-label">Manage the profile information for the subject of this account.</p>
						</div>

						<div class="setings-container mb-2">
							<div class="d-flex justify-content-between align-items-center">
								<h5 class="mb-0">Privacy</h5>
								<img id="stept3-trigger" src="assets/images/icons/open.svg" alt="Open Setting" class="img-fluid open-settings">
							</div>
						...
						<div class="setings-container mb-2">
							<div class="d-flex justify-content-between align-items-center">
								...
								<img id="stept4-trigger" src="assets/images/icons/open.svg" alt="Open Setting" class="img-fluid open-settings">
							</div>
						...
						<div class="setings-container mb-2">
							<div class="d-flex justify-content-between align-items-center">
								...
								<img id="stept5-trigger" src="assets/images/icons/open.svg" alt="Open Setting" class="img-fluid open-settings">
							</div>
							<p class="mt-2 main-label">Select a guest administrator for this account and see the account for which you are a guest administrator.</p>
						</div>

						<div class="setings-container mb-2">
							<div class="d-flex justify-content-between align-items-center">
								<h5 class="mb-0">Tags</h5>
								<img id="stept6-trigger" src="assets/images/icons/open.svg" alt="Open Setting" class="img-fluid open-settings">
							</div>
	...
	<script>
		// document.getElementById('step1-trigger').addEventListener('click', function() {
		...
		// 	document.getElementById('stepdiv1').classList.remove('totallyHide');


		// });

		// document.getElementById('step2-trigger').addEventListener('click', function() {
		...
		// 	document.getElementById('settings-options').style.display = 'none';
		// 	// document.getElementById('step1').style.display = 'block';
		// 	document.getElementById('stepdiv2').classList.remove('totallyHide');
