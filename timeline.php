                ...
                <div class="timeline-header">
                    <div class="row mt-1 mx-2 my-2">
                        <div class="text-start mb-2 col-9">
                            <h6 class="fw-normal fs-4"><img src="assets/images/icons/memories.png" alt="Back" style="height: 1em; vertical-align: middle; margin-right:10px;">Memory Timeline</h6>
                        </div>
                        <div class="text-end mb-2 col-3">
                            <button type="button" onclick="showForm('story');" class="btn btn-white text-black btn-next btn-timeline"><i class="bi bi-plus text-black"></i>Add </button>
                        </div>
                    </div>
                    ...
                    <div class="row mt-1 mx-2 my-2 align-items-center">
                        ...
                        <div class="text-end col-11">
                            <input type="text" class="form-control border-white" id="searchPara" name="searchPara" placeholder="Search" required>
                        </div>
                    </div>
                                    ...
                                    <div class="col-12 mb-2 w-100">
                                        <div class="mb-2 d-flex align-items-center justify-content-between">
                                            ...
                                            <div>
                                                ...
                                                <i class="bi bi-trash" onclick="saveAndClose()" style="cursor: pointer;"></i>
                                            </div>
                                        </div>
                    ...
                    $.get("search.php", {
                        ...
                        if (results.length > 0) {
                            results.forEach(user => {
                                suggestionBox.append(`<div class="suggestion" data-email="${user.email}">${user.name}</div>`);
                            });
                        } else {
